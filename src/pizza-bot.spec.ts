  ...
  describe('deliverPizza', () => {
    describe('basic movements', () => {
      ...
      test('should move north and drop pizza', () => {
        const pizzaBot = new PizzaBot([{ x: 0, y: 2 }]);
    ...
    describe('should deliver 2 pizzas', () => {
      describe('pizzas set horizontally/vertically of each other', () => {
        test('move east, move north', () => {
          const pizzaBot = new PizzaBot([{ x: 2, y: 0 }, {x: 2, y: 2}]);
    
          expect(pizzaBot.deliverPizza()).toBe('EEDNND');
        });
  
        test('move east, move south', () => {
          const pizzaBot = new PizzaBot([{ x: 2, y: 2 }, {x: 2, y: 0}]);
          pizzaBot.setCurrentPosition({x: 0, y: 2});
        ...
        test('move west, move north', () => {
          const pizzaBot = new PizzaBot([{ x: 0, y: 0 }, {x: 0, y: 2}]);
          pizzaBot.setCurrentPosition({x: 2, y: 0});
        ...
        test('move west, move south', () => {
          const pizzaBot = new PizzaBot([{ x: 0, y: 2 }, {x: 0, y: 0}]);
        ...
        test('move north, move east', () => {
          const pizzaBot = new PizzaBot([{ x: 0, y: 2 }, {x: 2, y: 2}]);
    
          expect(pizzaBot.deliverPizza()).toBe('NNDEED');
        });
  
        test('move north, move west', () => {
          const pizzaBot = new PizzaBot([{ x: 2, y: 2 }, {x: 0, y: 2}]);
          pizzaBot.setCurrentPosition({x: 2, y: 0});
        ...
        test('move south, move east', () => {
          const pizzaBot = new PizzaBot([{ x: 0, y: 0 }, {x: 2, y: 0}]);
          pizzaBot.setCurrentPosition({x: 0, y: 2});
        ...
        test('move south, move west', () => {
          const pizzaBot = new PizzaBot([{ x: 2, y: 0 }, {x: 0, y: 0}]);
          pizzaBot.setCurrentPosition({x: 2, y: 2});
      ...
      describe('pizzas set diagonally of each other', () => {
        ...
        test('move north-west, move south-west', () => {
          const pizzaBot = new PizzaBot([{ x: 2, y: 2 }, {x: 0, y: 0}]);
        ...
        test('move south-west, move north-west', () => {
          const pizzaBot = new PizzaBot([{ x: 2, y: 0 }, {x: 0, y: 2}]);
        ...
        test('move south-west, move south-east', () => {
          const pizzaBot = new PizzaBot([{ x: 0, y: 2 }, {x: 2, y: 0}]);
        ...
        test('move south-east, move north-east', () => {
          const pizzaBot = new PizzaBot([{ x: 2, y: 0 }, {x: 4, y: 2}]);
          pizzaBot.setCurrentPosition({x: 0, y: 2});
